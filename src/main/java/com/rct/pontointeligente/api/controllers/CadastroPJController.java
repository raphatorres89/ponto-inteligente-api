...
import com.rct.pontointeligente.api.enums.PerfilEnum;
...
public class CadastroPJController {
	...
	public ResponseEntity<Response<CadastroPJDto>> cadastrar(@Valid @RequestBody CadastroPJDto cadastroPJDto,
		...
		// @Valid chama o beans validation para verificar as regras
		// @RequestBody converte os dados recebidos para um objeto CadastroPJDto
	...
	private void validarDadosExistentes(CadastroPJDto cadastroPJDto, BindingResult result) {
		...
		this.funcionarioService.buscarPorCpf(cadastroPJDto.getCpf())
				.ifPresent(emp -> result.addError(new ObjectError("empresa", "CPF já existente.")));

		this.funcionarioService.buscarPorEmail(cadastroPJDto.getEmail())
				.ifPresent(emp -> result.addError(new ObjectError("empresa", "Email já existente.")));
	}
